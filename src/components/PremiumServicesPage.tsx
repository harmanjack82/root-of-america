...
export default function PremiumServicesPage({ onBack }: PremiumServicesPageProps) {
  ...
  const standardPrice = 600 + (standardAddons.customs ? 450 : 0) + (standardAddons.audit ? 300 : 0);
  const goldPrice = 1000 + (goldAddons.logistics ? 600 : 0) + (goldAddons.translation ? 450 : 0) + (goldAddons.speedMatch ? 550 : 0);
  const elitePrice = 1200 + (eliteAddons.booth ? 1200 : 0) + (eliteAddons.api ? 750 : 0) + (eliteAddons.legal ? 500 : 0);
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="py-5 border-t border-b border-gray-100 space-y-4">
                      ...
                      <div className="text-[10px] text-[#0e4a36] font-mono">
                        Base: $600/yr {standardAddons.customs || standardAddons.audit ? `+ selected add-ons` : ''}
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="py-5 border-t border-b border-gray-100 space-y-4">
                      ...
                      <div className="text-[10px] text-amber-600 font-mono">
                        Base: $1,000/yr {goldAddons.logistics || goldAddons.translation || goldAddons.speedMatch ? `+ selected add-ons` : ''}
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="py-5 border-t border-b border-gray-100 space-y-4">
                      ...
                      <div className="text-[10px] text-emerald-600 font-mono">
                        Base: $1,200/yr {eliteAddons.booth || eliteAddons.api || eliteAddons.legal ? `+ selected add-ons` : ''}
                      </div>
                ...
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 text-left">
                    <div>
                      ...
                      >
                        <option value="standard">Standard Verified Supplier ($600/yr)</option>
                        <option value="gold">Gold Premium VIP ($1,000/yr)</option>
                        <option value="elite">Enterprise Elite ($1,200/yr)</option>
                      </select>
                    </div>
